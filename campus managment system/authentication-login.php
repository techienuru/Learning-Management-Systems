...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $selecting_student = mysqli_query($connect, "SELECT * FROM `student` WHERE email = '$email' AND password = '$password'");
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="authentication-login.php" method="post">
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <p class="text-white">Dont have an account <a href="./authentication-register.php">Register</a></p>
                            </div>
                        </div>
