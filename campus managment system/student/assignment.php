...
<div class="row mt-4">
    <div class="col-12 stretch-card grid-margin">
        <div class="card bg-gradient-dark text-white shadow-lg animated fadeIn">
            <div class="card-body">
                <div class="container-fluid">
                    <h1 class="mt-4 text-dark display-4 text-uppercase text-center animated fadeInDown">Assignments</h1>
                    <?php
                    ...
                    if ($selecting_assignment) {
                        while ($fetching_assignment = mysqli_fetch_assoc($selecting_assignment)) {
                            ...
                            echo "
                            <div class='assignment-item p-4 my-3 bg-white text-dark rounded shadow-sm animated zoomIn'>
                                <h4 class='mb-3'>$course_code: $course_title</h4>
                                ...
                                <a href='../lecturer/$assignment_file' class='btn btn-outline-dark' download>Download Attachment</a>
                                <div class='mt-3'>
                                    <form action='assignment.php' method='POST' enctype='multipart/form-data'>
                                        ...
                                        <label class='mt-3'>Upload your assignment:</label>
                                        <input type='file' name='assignment_file' class='form-control-file border-dark' required>
                        ...
                        <div class='text-center'>
                            <p class='text-muted'>Chekc back later assignments</p>
                        </div>
                        ";
                    }
                    ?>
