...
@keyframes textGlow {
    0% {
        text-shadow: 0px 0px 10px rgba(0, 123, 255, 0.5), 0px 0px 20px rgba(0, 123, 255, 0.7);
    }
    100% {
        text-shadow: 0px 0px 20px rgba(0, 123, 255, 0.7), 0px 0px 30px rgba(0, 123, 255, 1);
    }
}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <h1 class="welcome-message">Welcome to Your Campus Dashboard!</h1>
                            <p class="sub-message">Manage your courses, assignments, and materials effortlessly.</p>
                        </div>
