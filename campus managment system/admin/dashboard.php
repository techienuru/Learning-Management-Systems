...
<body>
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      <div class="welcome-card card bg-gradient-primary text-white p-4 shadow-lg animated fadeIn">
        <h1 class="mb-4 text-dark">Welcome, Admin!</h1>
        <p class="lead mb-4 text-primary">
          Manage courses, assign lecturers, and streamline course management with ease.
        </p>
        <div class="row">
          <div class="col-md-4">
            <div class="card bg-gradient-light text-dark mb-4 shadow">
              <div class="card-body">
                <h5 class="card-title">Courses</h5>
                <p class="card-text">Add, edit, and remove courses in the system.</p>
          ...
          <div class="col-md-4">
            <div class="card bg-gradient-light text-dark mb-4 shadow">
              <div class="card-body">
                ...
                <p class="card-text">Add and assign lecturers to various courses.</p>
                <a href="add-lecturer.php" class="btn btn-primary">Manage Lecturers</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card bg-gradient-light text-dark mb-4 shadow">
              <div class="card-body">
                ...
                <p class="card-text">Assign courses to lecturers efficiently.</p>
                <a href="assign-course.php" class="btn btn-primary">Manage Assignments</a>
              </div>
            </div>
          </div>
        </div>
